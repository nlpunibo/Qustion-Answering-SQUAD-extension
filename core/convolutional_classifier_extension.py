...
def conv_classifier(test):
    ...
    # As model_checkpoint we use our distilbert_convolutional_classifier
    model_checkpoint = "nlpunibo/distilbert_convolutional_classifier"
    ...
    model = DistilBertConvolutionalClassifier.from_pretrained(model_checkpoint)
